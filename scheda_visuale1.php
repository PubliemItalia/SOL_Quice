...
if (($negozio == "labels") AND ($rigaq[rif_simboli] != "")) {
	...
	foreach ($array_famiglia as $sing_comp_fam) {
		...
		$preferiti_presenti = mysql_num_rows($risulteee);
		  if ($preferiti_presenti > 0) {
			echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_modal.php?avviso=del_bookmark&id_prod=".$rigak[id]."&negozio_prod=".$rigak[negozio]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS(".$x.")}})\">";
				echo "<div class=comandi>";
				echo "<span class=pulsante_preferiti>";
				switch ($_SESSION[lang]) {
					case "it":
				...
				echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_notifica.php?avviso=bookmark&negozio=".$rigak[negozio]."&id_prod=".$rigak[id]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS(".$x.")}})\">";
				echo "<div class=comandi>";
				echo "<span class=pulsante_preferiti>";
				switch ($_SESSION[lang]) {
					case "it":
...
/*if ($rigak[ordine_stampa] == 1) {
	...
	echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_ins_cart.php?avviso=ins_quant&negozio=".$rigak[negozio]."&id_prod=".$rigak[id]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\"><div class=pulsante_carrello title=\"$tooltip_inserisci_carrello\">";
	switch ($_SESSION[lang]) {
	case "it":
	echo "Inserisci nel carrello";
	break;
	  ...
	  if (($categoria3 == "120_Fogli_illustrativi") AND ($rigaq[simbolo_blister] == "")) {
		...
		while ($rigad = mysql_fetch_array($risultd)) {
		  ...
		  if ($nofunz != "") {
			...
			$preferiti_presenti = mysql_num_rows($risulteee);
			  if ($preferiti_presenti > 0) {
				echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_modal.php?avviso=del_bookmark&id_prod=".$rigad[id]."&negozio_prod=".$rigad[negozio]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\">";
				echo "<div class=comandi>";
				echo "<span class=pulsante_preferiti>";
				switch ($_SESSION[lang]) {
				  case "it":
			  ...
			  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_notifica.php?avviso=bookmark&negozio=".$rigad[negozio]."&id_prod=".$rigad[id]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\">";
			  echo "<div class=comandi>";
			  echo "<span class=pulsante_preferiti>";
			  switch ($_SESSION[lang]) {
				case "it":
			...
			if ($rigaq[extra] != "") {
			  ...
			  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_ins_cart.php?avviso=ins_quant&negozio=".$rigad[negozio]."&id_prod=".$rigad[id]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\"><div class=pulsante_carrello title=\"$tooltip_inserisci_carrello\">";
			  switch ($_SESSION[lang]) {
				case "it":
				echo "Inserisci nel carrello";
				break;
...
while ($rigac = mysql_fetch_array($risult0)) {
	$id_prod = $rigac[id];
		  ...
		  switch ($_SESSION[lang]) {
			case "it":
			echo str_replace("_"," ",substr($rigaf[categoria3_it],4));
			break;
			case "en":
			  if ($rigaf[categoria3_en] == "") {
				echo str_replace("_"," ",substr($rigaf[categoria3_en],4));
			  } else {
				echo str_replace("_"," ",substr($rigaf[categoria3_it],4));
			  }
			break;
		...
		echo "</div>";
		  ...
		  if ($nofunz != "") {
			...
			echo "<div class=comandi_spazio>";
			echo "</div>"; 
			$sqleee = "SELECT * FROM qui_preferiti WHERE id_prod = '$rigaf[id]' AND id_utente = '$_SESSION[user_id]'";
			$risulteee = mysql_query($sqleee) or die("Impossibile eseguire l'interrogazione" . mysql_error());
			$preferiti_presenti = mysql_num_rows($risulteee);
			if ($preferiti_presenti > 0) {
			  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_modal.php?avviso=del_bookmark&id_prod=".$id_prod."&negozio_prod=".$rigaf[negozio]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\">";
			  echo "<div class=comandi>";
			  echo "<span class=pulsante_preferiti>";
			  switch ($_SESSION[lang]) {
				case "it":
			  ...
			  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_notifica.php?avviso=bookmark&negozio=".$rigaf[negozio]."&id_prod=".$id_prod."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\">";
			  echo "<div class=comandi>";
			  echo "<span class=pulsante_preferiti>";
			  switch ($_SESSION[lang]) {
				case "it":
...
//		if ($rigaq[extra] != "") {
		  ...
		  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_ins_cart_etich_pharma.php?avviso=ins_quant&negozio=".$rigaf[negozio]."&id_prod=".$id_prod."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless2',width:610,height:480,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\"><div class=pulsante_carrello title=\"$scritta_puls\">";
		  }
		  echo $scritta_puls;
		  echo "</div></a>";
		  }
