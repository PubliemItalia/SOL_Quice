...
<div style="width:192px; height:15px; float:left;">
...
<div style="width:213px; height:15px; float:left;">
<!--vuoto-->
</div>
	<?php 
	...
	echo "<div style=\"width:36px; height:15px; float:left;\">";
	//vuoto-->
	echo '</div>
...
echo "</div>";
?>
<div style="width:194px; height:15px; float:left; text-align:right;">
...
<div id="testa">
    <div id="logo"><a href="index.php"><img src="immagini/logo-quice.gif" width="177" height="70" border="0" /></a></div>
  <!--END LOGO-->
      <?php 
  		  echo "<span style=\"color: rgb(0,0,0);\"><br><strong>".stripslashes(stripslashes($_SESSION[nome]))."</strong><br>".stripslashes($_SESSION[nomeunita]);
		  if ($_SESSION[ruolo_report] != "") {
			  $role = $_SESSION[ruolo_report];
		  } else {
...
?>
	<div id="subMenu">
				...
				<?php
					if ($vis_magazzino == "1") {
						$sqlt = "SELECT * FROM qui_buyer_negozi WHERE id_utente = '$id_utente' ORDER BY preferenza ASC LIMIT 1";
						...
						while ($rigat = mysql_fetch_array($risultt)) {
							$flusso_mag = $rigat[flusso];
							$_SESSION[flusso] = $flusso_mag;
						}
        ...
        //echo "<a href=lista_rda.php?a=1&archive=1&lista=RdA><div class=subsub style=\"color:red;\">";
				...
				switch ($flusso_mag) {
					...
					break;
					case "lab":
					  echo '<a href="report_righe_mag_publiem.php"><div class="subsub"'.$classe_process.'">';
					break;
				}
        ...
        /*echo "<a href=lista_rda.php?a=1&archive=1&lista=RdA><div class=subsub style=\"color:red;\">";
                ...
                echo "</div></a>"; */
                //echo "<li style=\"color:red;\">"; 
        echo '<a href="report_righe_nuovo.php?status=no_process"><div class="'.$classe_process.'" style="color:red;">';
							echo $tasto_rda_lav;
                //echo "</li>"; 
                echo "</div></a>"; 
					}
