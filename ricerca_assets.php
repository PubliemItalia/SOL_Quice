...
//costruzione query
$testoQuery = "SELECT DISTINCT paese, foto_paese FROM qui_prodotti_assets WHERE categoria1_it = '$categoria1' ORDER BY paese ASC";
...
echo "<a href=ricerca_settore_bombole_prec.php?categoria1=".$categoria1."&paese=".$rigaq[paese]."&negozio=".$_SESSION[negozio]."&lang=".$lingua.">";
...
echo "<a href=ricerca_prodotti.php?categoria1=".$categoria1."&paese=".$rigaq[paese]."&negozio=".$_SESSION[negozio]."&lang=".$lingua.">";
echo "<div class=riquadri_famiglia style=\"background-image:url(immagini/".strtolower($rigaq[paese]).".png);-ms-filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='immagini/".strtolower($rigaq[paese]).".png',sizingMethod='scale');filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=immagini/".strtolower($rigaq[paese]).".png,sizingMethod='scale');\">";
}
echo $rigaq[paese];
echo "</div>"; 
