...
<div id="confez5" style="padding-left: 20px; width: 55px; margin-right:0px;">
    <?php
	echo $testata_codice;
    ?>
</div>
<div class="descr4" style="width: 384px !important; padding-left: 10px;">
     <?php
...
<div class="price6_quant" style="padding-top: 0px;padding-right:85px;">
...
<!--<div class="vuoto9" style="width:70px;">
Stato RdA
</div>-->
</div>
...
<div id="blocco_generale" style="float:left;">
  ...
  */
  ...
  echo '<div class="descr4_riga" style="width:384px;">';
...
if ($stampa != "1") {
  ...
  echo "<a href=\"javascript:void(0);\" onclick=\"PopupCenter('packing_list.php?id_rda=".$sing_rda."&lang=".$lingua."&id_utente=".$id_utente."&mode=nuovo', 'myPop1',800,800);\">";
