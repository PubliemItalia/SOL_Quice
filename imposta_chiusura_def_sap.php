...
$query = "UPDATE qui_righe_rda SET id_buyer = '$id_buyer', flag_chiusura = '1', stato_ordine = '4' WHERE id_rda = '$id_rda'";
if (mysql_query($query)) {
} else {
echo "Errore durante l'inserimento: ".mysql_error();
}
$query = "UPDATE qui_rda SET buyer_output = '$id_buyer', id_buyer = '$id_buyer', nome_buyer = '$nome_buyer', data_chiusura = '$data_chiusura', data_ultima_modifica = '$data_chiusura', stato = '4' WHERE id = '$id_rda'";
if (mysql_query($query)) {
} else {
echo "Errore durante l'inserimento: ".mysql_error();
}	
...
$stato_visualizzazione = $rigay[stato];
}
...
$tab_output .= "</div>";
$tab_output .= "<a href=\"javascript:void(0);\" onclick=\"PopupCenter('stampa_rda.php?id=".$id_rda."&lang=".$lingua."', 'myPop1',1000,400);\"><div class=puls_servizio>";
