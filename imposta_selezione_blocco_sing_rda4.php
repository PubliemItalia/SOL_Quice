...
echo '<span style="color: #000;">Num_righe_rdasap_selezionate: '.$Num_righe_rdasap_selezionate.'<br>';
...
//$tab_output .= '<span style="color: #000;">statusDaModulo: '.$statusDaModulo.'</span><br>';
...
$dettaglio_stato = "Ordine Sap ".$rigan[ord_fornitore]."<br>".$rigan[fornitore_tx];
...
$dettaglio_stato = '<a href="ordine_fornitore.php?id_ord='.$rigaz[id_ordine_for].'&id_rda='.$rigan[id_rda].'" target="_blank"><span class="'.$colore_scritta.'">Ordine fornitore '.$rigaz[id_ordine_for].'</span></a>';
}
$aggiornamento_stato = date("d/m/Y",$rigan[data_output]);
break;
case "lab":
