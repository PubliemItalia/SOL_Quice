...
if ($ins_ord_sap == 1) {
if ($ordine_fornitore != "") {
  $query = "UPDATE qui_righe_rda SET stato_ordine = '4', assegnaz_fornitore = '$id_fornitore', fornitore_tx = '$tx_fornitore', ord_fornitore = '$ordine_fornitore', flag_buyer = '2', data_ultima_modifica = '".$data_attuale."' WHERE id_rda = '$id' AND output_mode = 'sap' AND flag_chiusura = '0' AND flag_buyer = '4'";
	} else {
