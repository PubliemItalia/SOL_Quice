...
//costruzione query
if ($clausole > 0) {
$sqlk = "SELECT * FROM qui_righe_rda WHERE id_rda = '$id_rda' AND output_mode = 'mag' AND evaso_magazzino = '0' AND ";
if ($clausole == 1) {
if ($a != "") {
$sqlk .= $a;
}
...
if ($clausole > 0) {
$sqln = "SELECT * FROM qui_righe_rda WHERE id_rda = '$id_rda' AND output_mode = 'mag' AND evaso_magazzino = '0' AND ";
if ($clausole == 1) {
if ($a != "") {
$sqln .= $a;
}
