  <div style="width: 100%; min-height: 70px; overflow:hidden; height: auto; background-color:#fff; font-family:Arial, Helvetica, sans-serif; font-size:12px; border-top:1px solid #A9A9A9; color: rgb(0,0,0);">
  ...
  <?php
	...
	switch ($file_presente) {
		...
		break;
		case "archivio_fatturazione.php":
			$colore_arch = $colore_rep;
			$colore_fatt = "#A9A9A9";
			$colore_giroc = "#A9A9A9";
			$colore_ord_sap = "#A9A9A9";
			$colore_ord = "#A9A9A9";
		break;
	...
	switch ($file_presente) {
		...
		case "ordini_sap.php":
		case "ordini.php":
		$colore_sfondo = $colore_rep;
		$sottomenu = '<a href="report_fatturazione.php?doc=G"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_giroc.';">
		  Giroconti
		</div></a>
		<a href="report_fatturazione.php?doc=F"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_fatt.';">
		  Richiesta Fattura
		</div></a>
		<a href="ordini_sap.php"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_ord_sap.';">
		  Ordini SAP
		</div></a>
		<a href="ordini.php"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_ord.';">
		  Ordini Fornitore
		</div></a>
		<a href="report_fatturazione.php?doc=R"><div style="cursor:pointer; padding: 10px; float:right; border-right:1px solid #A9A9A9; border-left:1px solid #A9A9A9; color:'.$colore_arch.';">
		...
		case "report_scorte_magazzino.php":
		case "lista_pl.php":
		$colore_sfondo = $colore_amm;
		  $sottomenu = '<a href="report_righe_admin.php"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_righe.';">
						  Report Righe
						</div></a>
						<a href="report_rda.php"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_rda.';">
						  Report RdA
						</div></a>
						<a href="lista_pl.php"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_pl.';">
						  Report Packing List
						</div></a>
						<a href="report_scorte_magazzino.php"><div style="cursor:pointer; padding: 10px; float:left; border-right:1px solid #A9A9A9; color:'.$colore_scorte.';">
						  Gestione Scorte
						</div></a>';
...
//echo '<span style="color:#A9A9A9;">file_presente: '.$file_presente.'<br>';
