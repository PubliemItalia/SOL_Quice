...
$queryb = "SELECT * FROM qui_spare_online ORDER BY id ASC";
$resultb = mysql_query($queryb);
while ($rowb = mysql_fetch_array($resultb)) {
$id_prodotto = $rowb[id];
$cod_online = $rowb[codice_art];
$queryc = "SELECT * FROM qui_prodotti_spare_parts WHERE codice_art = '$rowb[codice_art]' ORDER BY id ASC";
