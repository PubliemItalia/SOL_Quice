  <div style="width:auto; height:auto; ">
    ...
    ?>
       ...
       <div class="colonna" style="width:420px; height:174px; margin-right:40px; background-color:#fff; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; border: 1px solid #e6e6e6;">
        ...
        <div id="upload_image" style="width:330px; padding:0px 20px 0px 20px; float:none; height:65px; background-image:url(immagini/sfondo_icona_immagine.png); background-repeat:no-repeat;">
...
$blocco_righe_rda .= '</div>';
       ...
       <div class="colonna" style="width:960px; height:auto; background-color:#fff;	-moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px;  margin-bottom:20px;">
        <div style=" float:left; margin:auto; width:958px; height:240px; font-family:Arial; font-size:11px; width:920px; margin:0px 0px 20px 20px;">
          <div id="colonna_carico" style="width: 260px; height: 60px; float: left; margin: 0px 40px 0px 10px;"> 
            <div style="width:70px; float:left; margin:10px 0px 0px 0px; text-align:left;">Quantit&agrave;<br />da caricare</div>
            <div style="width:70px; float:left; margin-top:10px;">
             ...
             <div class="bottone_carica-cambia" style="margin-top:10px; margin-left:20px; width:80px; float:left;" onClick="carico_magazzino(1);">Carica</div>
          </div>
          <div id="colonna_opzioni" style="width: 600px; height: 60px; float: left;"> 
            <div style="width:70px; float:left; margin:10px 0px 0px 0px; text-align:left;">Gestione scorta</div>
             ...
             ?>" style="float: left; margin-top:10px;" onclick="solviv(this.id)"></div>
            <div style="width:70px; float:left; margin:10px 0px 0px 10px; text-align:left;">Quantit&agrave;<br />minima</div>
