...
$codice_php_testatina_righe = $blocco_testatina_righe;
	...
	$codice_php_testatina_righe = str_replace("stato prodotto",'',$codice_php_testatina_righe);
echo '<div class="cont_rda blocco_rda" style="display:block;" id="cont_gen">';
...
<div class=riassunto_rda style="margin-top:15px;">
  ...
  <div class="cont_rda blocco_rda" style="height:30px;" id="cont_nuovo">
...
function procedura_parziale(id_riga){
	...
	var tot_calcolato = quant_evasa*prezzo;
	  ...
	  if (confirm("Sei proprio sicuro di evadere parzialmente questa riga?") == true) {
		  ...
		  $.ajax({
				  type: "GET",   
				  url: "generazione_riga_parziale_mag.php",   
