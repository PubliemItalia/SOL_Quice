...
$querys = "SELECT * FROM qui_prodotti_assets_test WHERE codice_art = '$codice_art'";
...
$query = "UPDATE qui_prodotti_assets SET categoria3_it = '$categoria3_it', categoria4_it = '$categori4_it', foto_gruppo = '$foto_gruppo', foto_famiglia = '$foto_famiglia' WHERE id = '$id'";
