...
*/			  
	...
	switch ($file_presente) {
		default:
		  ...
		  <div style="width: 100%; float: left; height: 39px;">
			<input name="data_inizio" type="text" class="datepicker hasDatepicker" id="data_inizio" style="width:98%; height:27px;" value="'.$data_inizio.'">
		  </div>
		  <div  style="width: 100%; float: left; height: 20px;">
			<strong>Data fine</strong>
		  </div>
		  <div style="width: 100%; float: left; height: 39px;">
			<input name="data_fine" type="text" class="datepicker hasDatepicker" id="data_fine" style="width:98%; height:27px;" value="'.$data_fine.'">
		  </div>';
		break;
		case "report_scorte_magazzino.php":
		break;
	...
	switch ($file_presente) {
		default:
		$tab_output .= '<a href="'.$file_presente.'?a=1&doc='.$doc.'"><div style="background-color:#8d8d8d; color:#fff; padding:7px 0px; text-align: center; font-size: 12px; font-weight: bold; cursor:pointer;">Reset filtri</div></a>';
		break;
		case "report_righe_nuovo.php":
		$tab_output .= '<a href="report_righe_nuovo.php?status=no_process"><div style="background-color:#8d8d8d; color:#fff; padding:7px 0px; text-align: center; font-size: 12px; font-weight: bold; cursor:pointer;">Reset filtri</div></a>';
		 break;
	}
   $tab_output .= '</div>';
