<div id="ricerca" style="width:100%; height:170px; background-color: #ddd; margin-bottom: 20px; color:#000; float:left;">
  <div id=formRicerca>
  <?php
...
$array_societa = array("report_righe_admin.php", "lista_pl.php", "report_scorte_magazzino.php", "report_fatturazione.php", "ordini_sap.php", "ordini.php", "report_righe_nuovo.php", "report_righe_mag.php", "report_righe_mag_publiem.php");
$array_negozi = array("report_righe_admin.php", "report_rda.php", "report_scorte_magazzino.php", "report_fatturazione.php", "ordini_sap.php", "ordini.php", "report_righe_nuovo.php", "report_righe_mag.php", "report_righe_mag_publiem.php");
...
$array_categorie = array("report_righe_admin.php", "report_scorte_magazzino.php", "report_righe_nuovo.php", "report_righe_mag.php", "report_righe_mag_publiem.php");
//tendina società
...
$tendina_categoria = '<select name="categoria_righe" class="codice_lista_nopadding" id="categoria_righe" style="height:27px; width: 90%;" onchange="msc(this.id,this.value)"><option selected value="">Scegli categoria </option>'.$opzioni_categoria;
...
//echo 'file_presente: '.$file_presente.'<br>';
	//colonna 1-->
	echo '<div id="contenitore_msc" style="width: 100%; height: 170px; display:block;">
	...
	echo '</div>';
	//colonna 6-->
	echo '<div style="margin-top:15px; margin-bottom:15px; float:left; width:118px; margin-left:70px;">';
	...
	switch ($file_presente) {
		...
		case "report_righe_mag_publiem.php":
		case "lista_pl.php":
		echo '<div style="width: 100%; background-color:#06F; color:#fff; padding:7px 0px; text-align: center; font-size: 12px; font-weight: bold; cursor:pointer; margin-bottom:5px;" onclick="document.form_filtri2.submit();">
			Applica filtri
		  </div>';
		break;
		case "report_fatturazione.php":
		case "ordini_sap.php":
		case "ordini.php":
		  echo '<div style="width: 100%; background-color:#F63; color:#fff; padding:7px 0px; text-align: center; font-size: 12px; font-weight: bold; cursor:pointer; margin-bottom:5px;" onclick="document.form_filtri2.submit();">
			Applica filtri
		  </div>';
		break;
	}
	...
	switch ($file_presente) {
		default:
		echo '<a href="'.$file_presente.'?a=1&doc='.$doc.'"><div style="background-color:#8d8d8d; color:#fff; padding:7px 0px; text-align: center; font-size: 12px; font-weight: bold; cursor:pointer;">Reset filtri</div></a>';
		break;
		case "report_righe_nuovo.php":
		echo '<a href="report_righe_nuovo.php?status=no_process"><div style="background-color:#8d8d8d; color:#fff; padding:7px 0px; text-align: center; font-size: 12px; font-weight: bold; cursor:pointer;">Reset filtri</div></a>';
		 break;
	}
	  echo '</div>';
