...
$query = "UPDATE qui_righe_rda SET id_buyer = '$id_buyer', flag_chiusura = '1', stato_ordine = '4', n_ord_sap = '$flag_sap', n_fatt_sap = '$flag_sap', data_chiusura = '$data_chiusura', data_ultima_modifica = '$data_chiusura' WHERE id_rda = '$id_rda'";
