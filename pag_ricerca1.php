...
case "1":
$testoQuery = "SELECT * FROM qui_prodotti_assets WHERE obsoleto != '1' ";
$nome_negozio = "assets";
break;
case "2":
...
echo "<a href=ricerca_prodotti.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$cod_ricerca."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
} else {
	switch ($row[categoria1_it]) {
		default:
  echo "<a href=scheda_visuale.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$cod_ricerca."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
		break;
//		case "Etichette_ADR":
//  echo "<a href=scheda_visuale_etich.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$row[codice_art]."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
//		break;
		case "bombole":
		echo "";
//  echo "<a href=scheda_visuale_bombole.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$row[codice_art]."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
		break;
	}
}
/*	switch ($row[categoria1_it]) {
	...
	echo "<a href=\"javascript:void(0);\" onClick=\"TINY.box.show({iframe:'scheda_visuale.php?schedaVis=1&categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&codice_art=".$row[codice_art]."&paese=&nazione_ric=&negozio=".$row[negozio]."&lang=".$lingua."&nofunz=1',boxid:'frameless960',width:960,height:310,fixed:false,maskid:'bluemask',maskopacity:40})\"><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
		break;
		case "bombole":
  //echo "<a href=scheda_visuale_bombole.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$cod_ricerca."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
		break;
	}
*/
echo "</td>";
...
echo "<td class=open>";
if ($row[categoria3_it] == "") {
echo "<a href=ricerca_prodotti.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$row[codice_art]."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
} else {
	switch ($row[categoria1_it]) {
		default:
  echo "<a href=scheda_visuale.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$row[codice_art]."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
		break;
//		case "Etichette_ADR":
//  echo "<a href=scheda_visuale_etich.php?categoria1=".$row[categoria1_it]."&categoria2=".$row[categoria2_it]."&categoria3=".$row[categoria3_it]."&paese=&nazione_ric=&negozio=".$row[negozio]."&codice_art=".$row[codice_art]."&lang=".$lingua."&paese=".$row[paese]."><img src=immagini/btn_lente.png width=19 height=19 border=0 title=\"$tooltip_visualizza_scheda\"></a>";
//		break;
