...
$prev_page = $page - 1;
   ...
   if($page > 1) {
  echo "<b></b> <a href=".$_SERVER['PHP_SELF']."?limit=".$limit."&page=1&data_inizio=".$data_inizio."&data_fine=".$data_fine."&nr_pl=".$nrPlDaModulo."&societa=".$societaDaModulo."&unita=".$unitaDaModulo."&nr_rda=".$nrRdaDaModulo."&lang=".$lingua."><b>1</b></a>"; 
  }
if($prev_page >= 1) { 
  echo "<b></b> <a href=".$_SERVER['PHP_SELF']."?limit=".$limit."&page=".$prev_page."&data_inizio=".$data_inizio."&data_fine=".$data_fine."&nr_pl=".$nrPlDaModulo."&societa=".$societaDaModulo."&unita=".$unitaDaModulo."&nr_rda=".$nrRdaDaModulo."&lang=".$lingua."><b><<</b></a>"; 
} 
...
for($a = $pag_iniz; $a <= $pag_fin; $a++)
{
  ...
  echo("<a href=".$_SERVER['PHP_SELF']."?limit=".$limit."&page=".$a."&data_inizio=".$data_inizio."&data_fine=".$data_fine."&nr_pl=".$nrPlDaModulo."&societa=".$societaDaModulo."&unita=".$unitaDaModulo."&nr_rda=".$nrRdaDaModulo."&lang=".$lingua."> $a </a><img src=immagini/spacer.gif width=4 height=4>|<img src=immagini/spacer.gif width=4 height=4>");
     } 
} 
$next_page = $page + 1;
if($next_page <= $total_pages) {
   echo "<a href=".$_SERVER['PHP_SELF']."?limit=".$limit."&page=".$next_page."&data_inizio=".$data_inizio."&data_fine=".$data_fine."&nr_pl=".$nrPlDaModulo."&societa=".$societaDaModulo."&unita=".$unitaDaModulo."&nr_rda=".$nrRdaDaModulo."&lang=".$lingua."><b>>></b></a>"; 
} 
   echo "<a href=".$_SERVER['PHP_SELF']."?limit=".$limit."&page=".$last_page."&data_inizio=".$data_inizio."&data_fine=".$data_fine."&nr_pl=".$nrPlDaModulo."&societa=".$societaDaModulo."&unita=".$unitaDaModulo."&nr_rda=".$nrRdaDaModulo."&lang=".$lingua."><b>".$last_page."</b></a>"; 
?>
        </td>
      </tr>
    </table>
    ...
    if(verifica == 11){
	  ...
	  if (data2str-data1str<0) {
		...
		$.ajax({
		  ...
		  data: "societa="+socval+"&unita="+unitaval+"&data_inizio="+data_inizio_val+"&data_fine="+data_fine_val+"&file_presente=<?php echo $file_presente; ?>",
		  success: function(output) {
