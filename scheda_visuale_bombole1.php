...
$img_bombola = "";
		//componente bottoni
		echo "<div id=\"componente_bottoni_".$rigak[rif_famiglia]."\" class=\"componente_bottoni_bombole\">";
...
echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_ins_cart_etich_pharma.php?avviso=ins_quant&negozio=".$rigak[negozio]."&prezzo_pescante=".$prezzo_pescante."&id_prod=".$rigak[id]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless3',width:640,height:520,fixed:false,maskid:'bluemask',maskopacity:40});\"><div class=pulsante_carrello title=\"$scritta_puls\">";
//echo "id: ".$rigak[id]."<br>";
		  echo $scritta_puls;
		  echo "</div></a>";
