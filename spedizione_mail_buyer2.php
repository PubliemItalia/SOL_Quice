...
if ($ok_resp2 != "") {
$messaggio_resp = str_replace("#E-mail_utente:#",$testo_mail_responsabile,$messaggio_resp);
$messaggio_resp = str_replace("#E-mail_responsabile:#",$testo_mail_buyer,$messaggio_resp);
} else {
...
$oggetto = $oggetto_approvazione." ".$id_rda;
//**********************************************************************
...
$mail->From = $mittente;
$mail->FromName = "Quice - ".stripslashes($_SESSION[nome]);
$dataora = mktime();
