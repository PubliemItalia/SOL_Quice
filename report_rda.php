...
<div class="box_200" style="width:150px;">
...
<div class="box_100" style="width:150px;">
Company
</div>
<div class="box_100">
<?php echo $testata_status; ?>
</div>
<div class="box_130_dx" style="width:100px;">
...
echo "</div>";
echo '<div class="box_200" style="width:150px;">';
...
echo $row[nome_unita];
echo "</div>";
echo '<div class="box_100" style="width:150px;">';
$sqlw = "SELECT * FROM qui_company WHERE IDCompany = '$row[id_company]'";
$risultw = mysql_query($sqlw) or die("Impossibile eseguire l'interrogazione" . mysql_error());
while ($rigaw = mysql_fetch_array($risultw)) {
	if ($company_orig == $row[id_company]) {
	  echo stripslashes($rigaw[Company]);
	} else {
	  echo '<span style="color:red; font-weight:bold;">'.stripslashes($rigaw[Company]).'</span>';
	}
}
echo "</div>";
...
echo "</div>";
echo '<div class="box_130_dx" style="width:100px;">';
