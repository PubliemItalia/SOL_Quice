...
echo '<div id="componente_immagine_'.$rigak[rif_famiglia].'" class="componente_immagine_bombola" style="margin-top:10px; position: absolute; margin-left: 539px;">';
  echo '<div id="layer_corpo_'.$rigak[rif_famiglia].'" style="position: absolute; width:248px; height:248px; z-index:5;">';
	echo "<img src=componenti/bombole/RAL_5021.png width=248 height=248>";
  echo "</div>";
  echo '<div id="layer_ogiva_'.$rigak[rif_famiglia].'" style="position: absolute; width:248px; height:248px; z-index:7;">';
	echo "<img src=componenti/ogiva/RAL_6018.png width=248 height=248>";
  echo "</div>";
  echo '<div id="layer_valvola_'.$rigak[rif_famiglia].'" style="position: absolute; width:248px; height:248px; z-index:9;">';
	echo "<img src=componenti/valvola/Val020.png width=248 height=248>";
  echo "</div>";
  echo '<div id="layer_cap_'.$rigak[rif_famiglia].'" style="position: absolute; width:248px; height:248px; z-index:9;">';
