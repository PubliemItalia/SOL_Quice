...
$stringa = str_replace("Ã²","o",$stringa);
return $stringa;
}
...
switch($flusso) {
	...
	break;
	case "bmc":
	  $dir_rda=leggifile("config/sap_path_bmc.txt");
	break;
}
//$dir_rda="rda/";
//recupero dati rda
...
$query = "UPDATE qui_righe_rda SET flag_buyer = '2', output_mode = '$output_mode', stato_ordine = '3', data_output = '$data_adesso', data_ultima_modifica = '$data_adesso' WHERE id = '$ogni_riga'";
...
$query = "UPDATE qui_rda SET stato = '3', data_output = '$data_adesso', buyer_output = '$id_utente' WHERE id = '$id'";
