...
$testoQuery .= " ORDER BY categoria2_it ASC, precedenza_int ASC";
}
}
}
//} else {
...
//***********************************************************
		...
		$preferiti_presenti = mysql_num_rows($risulteee);
			if ($preferiti_presenti > 0) {
				echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_modal.php?avviso=del_bookmark&id_prod=".$rigaq[id]."&negozio_prod=".$rigaq[negozio]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS(".$x.")}})\">";
				echo "<div class=comandi>";
				...
				echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_notifica.php?avviso=bookmark&negozio=".$rigaq[negozio]."&id_prod=".$rigaq[id]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS(".$x.")}})\">";
				echo "<div class=comandi>";
				echo "<span class=pulsante_preferiti>";
				switch ($_SESSION[lang]) {
					case "it":
...
break;
case "vivistore":
$sqleee = "SELECT * FROM qui_prodotti_vivistore WHERE obsoleto = '0' AND categoria1_it = '$rigaq[categoria1_it]' AND categoria2_it = '$rigaq[categoria2_it]' ORDER BY id ASC LIMIT 1";
break;
}
			  ...
			  case 3:
				...
				echo "</div>";
				  ...
				  if ($nofunz != "") {
					...
					$preferiti_presenti = mysql_num_rows($risulteee);
					if ($preferiti_presenti > 0) {
					  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_modal.php?avviso=del_bookmark&id_prod=".$id_prod_virt."&negozio_prod=".$rigaf[negozio]."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\">";
					  echo "<div class=comandi>";
					  echo "<span class=pulsante_preferiti>";
					  switch ($_SESSION[lang]) {
						case "it":
					  ...
					  echo "<a href=\"javascript:void(0);\" onclick=\"TINY.box.show({iframe:'popup_notifica.php?avviso=bookmark&negozio=".$rigaf[negozio]."&id_prod=".$id_prod_virt."&id_utente=".$_SESSION[user_id]."&lang=".$lingua."',boxid:'frameless',width:400,height:170,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})\">";
					  echo "<div class=comandi>";
					  echo "<span class=pulsante_preferiti>";
					  switch ($_SESSION[lang]) {
						case "it":
